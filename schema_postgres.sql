...
CREATE TABLE IF NOT EXISTS fraud_scores (
    ...
    decision VARCHAR(30) NOT NULL DEFAULT 'PENDING_REVIEW' CHECK (decision IN ('AUTO_APPROVED','PENDING_REVIEW','BLOCKED','MANUAL_APPROVED','MANUAL_BLOCKED','MANUAL_PARTIAL')),
